  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
    <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      ...
      <nav class="hidden space-x-10 md:flex">
        ...
        <a href="/contacto" class="text-base font-medium text-gray-500 hover:text-gray-900">Contáctanos</a>
        ...
        <div class="relative">
          ...
          <div class="hidden left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
